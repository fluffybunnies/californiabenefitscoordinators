			...
			<div class="vertical_menu_area_bottom_logo">
				<div class="vertical_menu_area_bottom_logo_inner">
					<a href="javascript: void(0)">
						<img src="<?php echo esc_url($qode_options_proya['vertical_logo_bottom']); ?>" alt="vertical_menu_area_bottom_logo"/>
					</a>
				</div>
			</div>
		<?php } ?>
				...
				<?php if($display_header_top == "yes"){ ?>
					<div class="header_top clearfix" <?php echo $header_top_color_per_page; ?> >
						<?php if($header_in_grid){ ?>
							<div class="container">
								<div class="container_inner clearfix">
								<?php if($qode_options_proya['overlapping_content'] == 'yes') {?><div class="overlapping_content_margin"><?php } ?>
						<?php } ?>
								<div class="left">
									<div class="inner">
									<?php
							...
							<?php if($header_in_grid){ ?>
							<?php if($qode_options_proya['overlapping_content'] == 'yes') {?></div><?php } ?>
								</div>
							</div>
						<?php } ?>
					</div>
					...
					<?php } ?>
						<div class="header_inner_center">
							<div class="logo_wrapper" style="height: <?php echo $logo_height/2; ?>px;">
								...
								?>
								<div class="q_logo">
									<a style="height: <?php echo $logo_height/2; ?>px;" href="<?php echo home_url('/'); ?>">
										<img class="normal" src="<?php echo $logo_image; ?>" alt="Logo"/>
										<img class="light" src="<?php echo $logo_image_light; ?>" alt="Logo"/>
										<img class="dark" src="<?php echo $logo_image_dark; ?>" alt="Logo"/>
										<img class="mobile" src="<?php echo $logo_image_mobile; ?>" alt="Logo"/>
